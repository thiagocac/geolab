...
export const CAMPOS_RECEBIMENTO: CampoCatalogo[] = [
  ...
  { key: 'aditivo_adicionado', label: 'Aditivo adicionado na obra', hint: 'Registra sim/não e o aditivo (tipo/dose) acrescentado em campo, análogo à água adicionada.', on: true },
...
export const CAMPOS_CONCRETAGEM: CampoCatalogo[] = [
  ...
  { key: 'clima', label: 'Clima / condição no momento da moldagem', hint: 'Sai no bloco de dados do laudo. Nasce desligado.', on: false },
  { key: 'temperatura_ambiente', label: 'Temperatura ambiente (°C)', hint: 'Sai no bloco de dados do laudo. Nasce desligado.', on: false },
...
export const CAMPOS_FICHA: CampoCatalogo[] = [
  ...
  { key: 'numero_ficha', label: 'Número da ficha (Nº)', hint: 'Imprime o código da concretagem (ex.: CONC-2026-000123) como número da ficha, para arquivamento.', on: true },
