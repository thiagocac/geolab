...
export type ConfigLab = {
  ...
  dispersao_par_limite_pct: number;
  camara_temp_min_c: number;
  camara_temp_max_c: number;
  ...
  ficha_campos: Record<string, boolean> | null;
