...
export type CpRompimento = {
  ...
  concretagens?: { id: string; codigo: string | null; fck_previsto: number | null; fornecedor_texto: string | null; client_works?: { nome: string | null } | null; lab_clients?: { razao_social: string | null; nome_fantasia?: string | null } | null } | null;
};
...
// E1 — aceitação por exemplar na idade de controle (28d). Dispara resultado_abaixo_fck
// SE o exemplar (maior do par no 28d) < fck. Idades menores não reprovam (acompanhamento).
