  ...
  return (
    <section className="space-y-4">
      ...
      <Card className="p-5">
        <div className="space-y-4">
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <NumField label="FCK (MPa)" value={num(form.fck_previsto)} onCommit={(n) => patch('fck_previsto', n)} min={1} max={150} soft={[10, 100]} />
            ...
            <NumField label="Volume previsto (m³)" value={num(form.volume_programado_m3)} onCommit={(n) => patch('volume_programado_m3', n)} min={0} max={999} dec={2} soft={[0, 500]} />
      ...
      <div className="form-actions">
        ...
        <Button onClick={() => void salvar()} busy={busy}>{busy ? 'Salvando…' : 'Salvar programação'}</Button>
      </div>
