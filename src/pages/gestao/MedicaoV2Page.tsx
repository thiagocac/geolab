...
export function MedicaoV2Page() {
  ...
  return <div className="space-y-5">
    <PageHeader kicker="Financeiro" title="Medições v2" description="Snapshot de itens, documento versionado, envio seguro, decisão do cliente e integração com faturamento." />
