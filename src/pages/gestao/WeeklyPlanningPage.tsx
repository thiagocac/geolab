...
export function WeeklyPlanningPage() {
  ...
  return <div className="space-y-6">
    ...
    <Modal open={!!selected} title="Atribuir operação" onClose={() => setSelected(null)} footer={<><Button variant="ghost" onClick={() => setSelected(null)}>Cancelar</Button><Button disabled={busy} onClick={() => void save()}>{busy ? 'Salvando...' : 'Salvar atribuição'}</Button></>}>
