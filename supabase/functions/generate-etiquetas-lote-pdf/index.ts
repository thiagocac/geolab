...
serveWithTelemetry('generate-etiquetas-lote-pdf', async (req) => {
  ...
  try {
    ...
    return serverError(e, { req, fnName: 'generate-etiquetas-lote-pdf', action: 'relatorio.pdf:generate-etiquetas-lote-pdf' });
  }
});
