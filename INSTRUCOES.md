# INSTRUÇÕES — Release v93 (helper de exportação Excel + consolida v88 do laudo)
...
cujos fontes NÃO estão na pasta. Numerei **v93** e **consolidei o v88** (laudo) aqui. Os deltas são cirúrgicos →
**cherry-pick os arquivos abaixo sobre o HEAD atual** do repo. Sessões paralelas avançaram até v92 (fora da pasta) → numerei **v93** (provisório; defina o nº na reconciliação). Descarte os zips `...-v84...`, `...-v88...` e `...-v89...` (superseded/colidiram).
...
VERSÃO:
- public/sw.js / src/lib/telemetry/core.ts → bump v93 (ajuste se o HEAD já estiver acima)
